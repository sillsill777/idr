...
if __name__ == '__main__':
    ...
    parser.add_argument('--conf', type=str, default='C:/Users/willy/Desktop/idr/code/confs/dtu_fixed_cameras.conf')
    ...
    parser.add_argument('--checkpoint', default='latest',type=str,
                        help='The checkpoint epoch number of the run to be used '
                             'in case of continuing from a previous run.')
